...
@ConfigurationProperties(prefix = AlibabaCloudCaptchaProperties.PROPERTY_PREFIX)
@Data
public class AlibabaCloudCaptchaProperties implements InitializingBean {
    public static final String PROPERTY_PREFIX = "navi.cloud-service.alibaba-cloud.captcha";
