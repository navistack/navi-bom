...
class AntiSamyContentSanitizerTest {
    ...
    @Test
    void shouldRemoveEventHandlerAttributesWhenSanitizingHtml() throws Exception {
    ...
    @Test
    void shouldKeepSafeAnchorTagWhenSanitizingHtml() throws Exception {
        AntiSamyContentSanitizer sanitizer = new AntiSamyContentSanitizer();
    ...
    @Test
    void shouldRemoveAnchorWithJavaScriptHrefWhenSanitizingHtml() throws Exception {
        AntiSamyContentSanitizer sanitizer = new AntiSamyContentSanitizer();
    ...
    @Test
    void shouldRemoveAnchorWithVbscriptHrefWhenSanitizingHtml() throws Exception {
        AntiSamyContentSanitizer sanitizer = new AntiSamyContentSanitizer();
    ...
    @Test
    void shouldRemoveScriptTagWhenSanitizingHtml() throws Exception {
        AntiSamyContentSanitizer sanitizer = new AntiSamyContentSanitizer();
