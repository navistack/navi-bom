...
import org.navistack.boot.autoconfigure.web.rest.SecurityRestResultSupport;
...
public class RestResultHttpSecurityBeanPostProcessor implements BeanPostProcessor {
    private final ObjectProvider<SecurityRestResultSupport> securityProblemSupport;
    ...
    private void register(final HttpSecurity http, final String beanName, final SecurityRestResultSupport support) {
        try {
